...
## Always the student (do not submit)
...
`submit_assignment` preview → show the student → redeem token only if auto bar passed.

### If no PAT

Do not claim submitted. For native Canvas busywork, draft the text/files and ask the student to paste/upload, **or** wait for PAT. Do not auto-click Canvas Submit in the browser unless the student explicitly approves that one item and it meets the auto bar.
