...
| Doc | Status |
|-----|--------|
| [`docs/design/spatial-instrument-brief.md`](design/spatial-instrument-brief.md) | **Briefed, not implemented** (2026-09-18) — owner look-alike spec; style tile before any product restyle. Execution prompt: [`handoff/spatial-instrument-build-prompt.md`](handoff/spatial-instrument-build-prompt.md) |
