...
**2026-09-21:** Canvas reliability core (staged generations, reconcilers, grade scenarios, Home/Calendar/Plan projections) landed on this branch. Last complete `sync_id` is shown on deadline/grade surfaces. Study remains schema-2 until live adapter comparison. See [`docs/design/canvas-reliability-architecture.md`](../../design/canvas-reliability-architecture.md).
